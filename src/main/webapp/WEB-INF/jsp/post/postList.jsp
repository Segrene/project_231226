...
<div class="bg-dark" id="productList">
	...
	<div class="d-flex flex-wrap justify-content-around">
		...
		<div class="PBox bg-warning border-dark rounded m-3"
		 onclick="location.href='/post/postId/${post.post.id}';" style=" cursor: pointer;">
			<div class="d-flex PThumbnail align-items-center justify-content-center">		
				<img src="${post.post.imagePath}" class="rounded" width="200px" height="200px">
			</div>
			<div class="ml-3 mb-2 PName">${post.post.name}</div>
			<div class="ml-3 mb-2">${post.user.name}</div>
		</div>
		</c:forEach>
	</div>
</div>